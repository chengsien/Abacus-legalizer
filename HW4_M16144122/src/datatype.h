...
extern HASH_MAP<string, NET *> net_map;
...
// 0930
// extern unordered_map<string,*MODULE> module_map;
...
public:
    ...
    string category = "";
    int orientation = 0;   /// 0(N), 1(W), 2(S), 3(E), 4(FN), 5(FW), 6(FS), 7(FE)
    bool is_cover = false; /// 固定但可重疊 (terminal NI)
